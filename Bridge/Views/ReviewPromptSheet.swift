...
struct ReviewPromptSheet: View {
    ...
    private var navigationTitle: String {
        switch step {
        case .enjoyment: "Enjoying Bridge Trainer?"
    ...
    private var enjoymentContent: some View {
        VStack(spacing: 20) {
            ...
            Text("You've finished \(ReviewPromptTracker.positiveMomentCount) drills. If Bridge Trainer is helping the game stick between sessions, a quick rating helps other players find it.")
                .font(.subheadline)
                .foregroundStyle(Theme.inkSecondary)
    ...
    private var reviewPitchContent: some View {
        VStack(spacing: 18) {
            ...
            Text("Bridge Trainer is built by one person. No ads, no accounts, and your practice history never leaves your phone.")
                .font(.subheadline)
                .foregroundStyle(Theme.inkSecondary)
                .multilineTextAlignment(.center)
                .fixedSize(horizontal: false, vertical: true)
    ...
    private var feedbackContent: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("What would make Bridge Trainer better for you?")
                .font(.headline)
    ...
    static func feedbackMailURL(body: String) -> URL? {
        ...
        components.queryItems = [
            URLQueryItem(name: "subject", value: "Bridge Trainer feedback"),
