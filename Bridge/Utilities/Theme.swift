...
enum Theme {
    ...
    static let cardIvory = Color(light: (0.985, 0.965, 0.915), dark: (0.93, 0.90, 0.83))
    static let cardEdge = Color(light: (0.84, 0.79, 0.68), dark: (0.70, 0.65, 0.54))
    static let cardRed = Color(red: 0.72, green: 0.17, blue: 0.16)
    static let cardBlack = Color(red: 0.12, green: 0.11, blue: 0.10)
    static let successGreen = Color(red: 0.12, green: 0.47, blue: 0.29)
    static let errorRed = cardRed
