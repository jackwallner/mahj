...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "mahj_onboarding_trial")
        ConversionDiagnostics.recordPitchView(impressionID: "mahj_onboarding_trial")
        ConversionDiagnostics.recordPitchView(impressionID: "mahj_paywall_sheet")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "mahj_\(long)")
