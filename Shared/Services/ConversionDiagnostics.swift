...
/// On-device record of how someone met Mahj Plus before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.mahj", category: "Conversion")
    ...
    private static let impressionPrefix = "mahj_"
